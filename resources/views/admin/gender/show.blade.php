...
<div class="main-container-middle">
    <div class="container-header container-customer" style="overflow:visible;">
        <div class="row align-items-center justify-content-between p-3">
            <div class="col-12 col-md-6 mb-3 mb-md-0 h5 m-0">
                <a href="{{ url('admin/gender/list') }}" class="btn btn-outline-primary px-2 mr-3" title="{{ Helper::trans('gender.back_to_[object Object]', 'Back to gender list') }}"><i class="fas fa-arrow-left"></i></a>
                <span>{{ Helper::trans('gender.info_title', 'Gender info') }} ( {{ $model_info->gender_name }} )</span>
            </div>
            
            <div class="col-12 col-md-6 d-none d-md-block text-right">
                <!-- <a href="{{ url('admin/gender/edit/' . $model_info->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt mr-1"></i> {{ Helper::trans('general.edit', 'edit') }}</a> -->
                <a href="{{ url('admin/gender/create') }}" class="btn btn-dark"><i class="fas fa-plus-circle mr-1"></i>{{ Helper::trans('gender.gender', 'Add Gender') }} </a>
    ...
    <div class="container-detail">
        <div class="container-customer">
            <div class="px-3 mb-3">
                {!! \App\Handlers\Admin\Gender\ShowFormHandler::handler(request(), $model_info->id) !!}
            </div>
        </div>
    </div>
</div>
