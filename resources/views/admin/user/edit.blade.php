...
<div class="main-container-middle">
    <div class="container-header container-customer" style="overflow:visible;">
        <div class="d-flex align-items-center justify-content-between p-3">
            <div class="h5 m-0">
                <a href="{{ url('admin/user/list') }}" class="btn btn-outline-primary mr-3" title="{{ Helper::trans('user.back_to_[object Object]', 'Back to user list') }}"><i class="fas fa-arrow-left"></i></a>
                <span>{{ Helper::trans('user.edit_title', 'Edit user') }} ( {{ $model_info->first_name }} )</span>
            </div>
            <div>
                <a href="{{ url('admin/user/create') }}" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i> {{ Helper::trans('general.add_new', 'Add new') }}</a>
                <!-- <a href="{{ url('admin/user/list') }}" class="btn btn-primary"><i class="fas fa-list mr-1"></i> {{ Helper::trans('general.list', 'List') }}</a> -->
        ...
        <div class="container-customer">
            <div class="px-3 mb-3">
                <div class="card card-body bg-white p-5">
                    {!! \App\Handlers\Admin\User\EditFormHandler::handler(request(), $model_info->id, false) !!}
                </div>
            </div>
        </div>
    </div>
